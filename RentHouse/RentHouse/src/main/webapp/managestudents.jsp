...
<head>
    ...
    <title>Manage Students - MyHome</title>
    ...
    <section class="manage-students">
        ...
        <%
            ...
            try {
                ...
                String query = "SELECT email,phone FROM users WHERE role = 'student'";
                stmt = conn.prepareStatement(query);
                rs = stmt.executeQuery();

                if (!rs.isBeforeFirst()) {
                    out.println("<p class='no-students'>No students found.</p>");
                } else {
        %>
        ...
        <%
                ...
                out.println("<p class='error-message'>Error retrieving students: " + e.getMessage() + "</p>");
            } finally {
